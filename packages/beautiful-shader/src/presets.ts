...
const presetInputs: PresetInput[] = [
  ...
  { id: "BS-019", title: "Painterly Botanical Field", category: "Organic", base: "full-coverage", palette: 5, density: "balanced", mood: "botanical", grain: "woven canvas", interaction: 0, scale: 0.74, warp: 2.95, speed: 0.48, hue: 0.012, octaves: 5, grainStrength: 0.11, flowPattern: "painterly-bloom", summary: "Layered teal, moss, cream, and blush blooms with dry-brush texture and a subtle canvas weave.", use: "Organic art direction, garden/editorial heroes, calm brand moments, and painterly backgrounds." },
  { id: "BS-020", title: "Abstract Moss Wash", category: "Organic", base: "light-accent", palette: 5, density: "wide", mood: "soft organic", grain: "light canvas", interaction: 0, scale: 0.58, warp: 2.25, speed: 0.36, hue: 0.008, octaves: 4, grainStrength: 0.07, flowPattern: "painterly-bloom", summary: "A quieter paper-first version with organic pigment pools and airy botanical highlights.", use: "Documentation headers, natural wellness pages, editorial section breaks, and light-mode art panels." },
];
