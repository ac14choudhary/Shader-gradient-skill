...
1. **Places your request on a use-case table** — small UI element vs. full-bleed hero
   ...
   interactivity, motion speed, and palette density from it. This is the part most
   AI-generated shaders skip, and it's why they all look the same regardless of context.
...
4. **Ships a framework-free JS scaffold**: an attribute-less fullscreen triangle (zero
   ...
   baked in from the start, not bolted on after.
